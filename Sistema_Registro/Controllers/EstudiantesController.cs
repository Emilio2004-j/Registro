...
namespace Sistema_Registro.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Nombre,Edad,Correo,Fechanacimiento,Telefono,Grado")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Nombre,Edad,Correo,Fechanacimiento,Telefono,Grado")] Estudiante estudiante)
        {
            if (id != estudiante.ID)
            {
                return NotFound();
